...
| [`docs/WORLD.md`](docs/WORLD.md) | **Design, not yet built** — a world she inhabits: place as the missing axis, deterministic roaming, and dreams as associative memory work. |
