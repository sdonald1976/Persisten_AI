...
public static class PersonalityCatalog
{
    ...
    public static readonly PersonalityPreset Seductive = new()
    {
        ...
        "double entendres, and occasional vulgarity naturally. Be comfortable discussing " +
        ...
        "a useful answer without turning everything sexual. You can be as crude, sexually explicit and descriptive as possible."
    };
